...
import (
	...
	"github.com/develder/millibee/pkg/auth"
...
func authHelp() {
	...
	fmt.Println("  millibee auth login --provider openai")
	fmt.Println("  millibee auth login --provider openai --device-code")
	fmt.Println("  millibee auth login --provider anthropic")
	fmt.Println("  millibee auth login --provider google-antigravity")
	fmt.Println("  millibee auth models")
	fmt.Println("  millibee auth logout --provider openai")
	fmt.Println("  millibee auth status")
}
...
func authLoginGoogleAntigravity() {
	...
	fmt.Println("Try it: millibee agent -m \"Hello world\"")
}
...
func authStatusCmd() {
	...
	if len(store.Credentials) == 0 {
		...
		fmt.Println("Run: millibee auth login --provider <name>")
		return
	}
...
func authModelsCmd() {
	...
	if err != nil || cred == nil {
		...
		fmt.Println("Run: millibee auth login --provider google-antigravity")
		return
	}
