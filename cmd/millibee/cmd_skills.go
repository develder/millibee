...
func skillsHelp() {
	...
	fmt.Println("  millibee skills list")
	fmt.Println("  millibee skills install develder/millibee-skills/weather")
	fmt.Println("  millibee skills install-builtin")
	fmt.Println("  millibee skills list-builtin")
	fmt.Println("  millibee skills remove weather")
	fmt.Println("  millibee skills install --registry clawhub github")
}
...
func skillsInstallCmd(installer *skills.SkillInstaller, cfg *config.Config) {
	if len(os.Args) < 4 {
		fmt.Println("Usage: millibee skills install <github-repo>")
		fmt.Println("       millibee skills install --registry <name> <slug>")
		return
	}
	...
	if os.Args[3] == "--registry" {
		if len(os.Args) < 6 {
			fmt.Println("Usage: millibee skills install --registry <name> <slug>")
			fmt.Println("Example: millibee skills install --registry clawhub github")
			return
		}
...
func skillsInstallBuiltinCmd(workspace string) {
	builtinSkillsDir := "./millibee/skills"
...
func skillsListBuiltinCmd() {
	...
	builtinSkillsDir := filepath.Join(filepath.Dir(cfg.WorkspacePath()), "millibee", "skills")
