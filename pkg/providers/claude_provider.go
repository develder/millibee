...
import (
	...
	anthropicprovider "github.com/develder/millibee/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: millibee auth login --provider anthropic")
		}
